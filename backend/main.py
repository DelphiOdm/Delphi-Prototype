...
# # origins = ["http://172.16.60.19:3000/"]
...
# main.py
"""
Minimal FastAPI app that only mounts the lead-scores router.
Place this file in your backend folder and run with:
    uvicorn main:app --reload
Make sure your package `apis.leadscores` exists (with __init__.py) and
that it exposes `router` (an APIRouter). If the import fails, a placeholder
route will return a clear 503 error so the server still starts for easier debugging.
"""
