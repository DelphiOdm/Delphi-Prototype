...
//           Propensity scores for {year} leads
//         </span>
//       </div>
...
//               {/* <th className="px-6 py-4 text-center font-semibold">Propensity Score</th>
...
//                     onClick={() => window.open(`/leads/${l.Lead_id}`)}
//                   >
//                     View Analysis
//                   </button>
//                 </td> */}
...
//         <div className="flex justify-end items-center p-4 gap-3 bg-gray-50 border-t">
//           <button
